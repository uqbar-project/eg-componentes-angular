...
import { Usuario, FEMENINO } from './usuario.domain'
...
describe('UsuarioComponent', () => {
  ...
  beforeEach(() => {
    ...
    component.usuario = new Usuario('Guadalupe Gerschwin', 'La vida es muy corta para poner una frase ingeniosa', FEMENINO)
